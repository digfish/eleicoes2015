...
namespace {
    ...
    class MyRSS extends \Vinelab\Rss\Facades\RSS{
         ...
         * @param string $url
         * @param string $format
         * @return \Vinelab\Rss\Vinelab\Rss\ArticlesCollection 
         * @static 
         */
    ...
    class Restable extends \Teepluss\Restable\Facades\Restable{
        ...
        public static function setDefaultFormat($format){
            return \Teepluss\Restable\Restable::setDefaultFormat($format);
        }
        ...
        public static function code($code){
            return \Teepluss\Restable\Restable::code($code);
        }
         ...
         * @static 
         */
        public static function listing($messages){
            return \Teepluss\Restable\Restable::listing($messages);
        }
         ...
         * @static 
         */
        public static function single($messages){
            return \Teepluss\Restable\Restable::single($messages);
        }
         ...
         * @static 
         */
        public static function created($messages){
            return \Teepluss\Restable\Restable::created($messages);
        }
         ...
         * @static 
         */
        public static function updated($messages){
            return \Teepluss\Restable\Restable::updated($messages);
        }
        ...
        public static function deleted(){
            return \Teepluss\Restable\Restable::deleted();
        }
        ...
        public static function success($message){
            return \Teepluss\Restable\Restable::success($message);
        }
         ...
         * @static 
         */
        public static function error($messages, $type = 400){
            return \Teepluss\Restable\Restable::error($messages, $type);
        }
         ...
         * @static 
         */
        public static function unauthorized($description = null){
            return \Teepluss\Restable\Restable::unauthorized($description);
        }
         ...
         * @static 
         */
        public static function bad($description = null){
            return \Teepluss\Restable\Restable::bad($description);
        }
         ...
         * @static 
         */
        public static function missing($description = null){
            return \Teepluss\Restable\Restable::missing($description);
        }
         ...
         * @static 
         */
        public static function unprocess($errors){
            return \Teepluss\Restable\Restable::unprocess($errors);
        }
         ...
         * @static 
         */
        public static function render($format = null, $callback = null){
            return \Teepluss\Restable\Restable::render($format, $callback);
        }
         ...
         * @static 
         */
        public static function to($format, $callback = null){
            return \Teepluss\Restable\Restable::to($format, $callback);
        }
